...
```bash
docker pull ghcr.io/skh2945932142/omp-switch-cli:0.3.3
docker run --rm -v "$HOME/.omp:/home/node/.omp"   ghcr.io/skh2945932142/omp-switch-cli:0.3.3 validate --profile default
```
