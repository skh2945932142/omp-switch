...
```bash
docker pull ghcr.io/skh2945932142/omp-switch-cli:0.3.1
docker run --rm -v "$HOME/.omp:/home/node/.omp"   ghcr.io/skh2945932142/omp-switch-cli:0.3.1 validate --profile default
```
