...
> `v0.4.1` is released — see [Releases](https://github.com/skh2945932142/omp-switch/releases). The
...
docker run --rm -v "$HOME/.omp:/home/node/.omp" \
  ghcr.io/skh2945932142/omp-switch-cli:0.4.1 validate --profile default
```
