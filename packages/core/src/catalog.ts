...
export const PROVIDER_PRESETS: readonly ProviderPreset[] = [
  ...
  preset("deepinfra", "DeepInfra", "https://api.deepinfra.com/v1/openai", "openai-completions", "Hosted", { auth: "apiKey", discovery: { type: "openai-models-list" } }),
  ...
  preset("siliconflow", "SiliconFlow", "https://api.siliconflow.com/v1", "openai-completions", "Regional", { auth: "apiKey", discovery: { type: "openai-models-list" } }),
  preset("siliconflow-cn", "SiliconFlow CN", "https://api.siliconflow.cn/v1", "openai-completions", "Regional", { auth: "apiKey", discovery: { type: "openai-models-list" } }),
